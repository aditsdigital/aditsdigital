...
import { Search, TrendingUp, Target, BarChart, CheckCircle, Sparkles } from "lucide-react";
...
export default function SEO() {
  ...
  const features = [
    ...
    },
    {
      icon: TrendingUp,
      title: "Technical SEO",
      description: "Comprehensive technical optimization including site speed, mobile-friendliness, and crawlability.",
    ...
    },
    {
      ...
      description: "Strategic optimization of content, meta tags, headers, and internal linking structure.",
    ...
    },
    {
      icon: BarChart,
      title: "Link Building",
      description: "High-quality backlink acquisition from authoritative websites in your industry.",
  ...
  return (
    <div>
      <Hero
        title="SEO Services"
        subtitle="Dominate search results and drive sustainable organic growth with our comprehensive SEO strategies."
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-6" data-testid="text-seo-what-heading">
                What is SEO?
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Search Engine Optimization (SEO) is the practice of optimizing your website to rank higher in search engine results pages (SERPs). Our data-driven SEO strategies help businesses increase visibility, attract qualified traffic, and achieve sustainable growth.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                We combine technical expertise, content optimization, and strategic link building to improve your search rankings and drive meaningful results for your business.
              </p>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Comprehensive SEO solutions designed to improve your rankings and drive organic growth.
            </p>
          </motion.div>
