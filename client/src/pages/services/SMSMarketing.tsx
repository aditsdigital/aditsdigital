...
import { MessageSquare, Zap, Target, TrendingUp, CheckCircle, Sparkles } from "lucide-react";
...
export default function SMSMarketing() {
  ...
  const benefits = [
    ...
    "Direct reach to mobile devices",
  ...
  const features = [
    {
      icon: MessageSquare,
      title: "SMS Campaigns",
      description: "Targeted SMS campaigns to promote offers, updates, and important announcements.",
    ...
    },
    {
      ...
      description: "Messages delivered instantly to reach customers at the perfect moment.",
    ...
    },
    {
      icon: Target,
      title: "Segmentation",
      description: "Precise audience targeting based on behavior, preferences, and demographics.",
    ...
    },
    {
      icon: TrendingUp,
      title: "Analytics",
      description: "Detailed reporting on delivery rates, engagement, and conversion metrics.",
  ...
  return (
    <div>
      <Hero
        title="SMS Marketing"
        subtitle="Reach customers instantly with high-impact SMS campaigns that drive immediate action and results."
        ctaText="Start SMS Marketing"
        ctaLink="/contact"
      />
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-3xl sm:text-4xl font-bold mb-6" data-testid="text-sms-heading">
                The Power of SMS Marketing
              </h2>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                SMS marketing boasts a 98% open rate, making it one of the most effective channels for reaching customers. Our strategic SMS campaigns help you connect with your audience instantly and drive immediate action.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                From flash sales to appointment reminders, SMS marketing delivers your message directly to customers' hands.
              </p>
            </motion.div>
      ...
      <section className="py-20 bg-muted/30 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6" data-testid="text-features-heading">SMS Marketing Features</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">Everything you need for successful SMS campaigns.</p>
          </motion.div>
      ...
      <section className="py-24 bg-gradient-to-br from-primary via-primary/90 to-chart-3 text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-6">Launch Your SMS Campaign</h2>
          <p className="text-xl mb-10 text-primary-foreground/90 leading-relaxed">Connect with customers instantly and drive immediate results.</p>
